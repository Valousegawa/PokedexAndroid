...
This application is a project for INSTA in order to practice Android in a clean architecture way. It is made by Valentin HUYENH and directed by Nicolas TELERA.
...
An APK has been generated, please find it in : app\build\outputs\apk


Sources
-+*+-+*+-+*+-+*+-+*+-+*+-+*+-+*+-+*+-+*+-+*+-+*+-+*+-+*+-+*+-

Thanks to Pokeapi (https://pokeapi.co/) for providing this open API.
Find this project on GitHub too : https://github.com/Valousegawa/PokedexAndroid
...
PS : Gary was here, Ash's a loser !